...
using Core.Universal.Models.Settings;

namespace Core.Universal
{
    /// <summary>
        ...
        public App()
        {
            Host = UnoHost
                .CreateDefaultBuilder(true)
                    ...
                    .Build()
                    //uses same logging framework for UNO logs.
                    .ConnectUnoLogging(true)
                    ;
            //InitializeLogging(); do not need this anymore, since we are using uno extensions now.
